...
function generateReadmeFromSelection(
  ...
  lines.push("");
  lines.push("This is an [Agent Company](https://raava.ing) package.");
  lines.push("");
  ...
  lines.push("```");
  lines.push("");
  lines.push("See [Raava](https://raava.ing) for more information.");
  lines.push("");
  lines.push("---");
  lines.push(`Exported from [Raava](https://raava.ing) on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");
